# AI Resources, Best Practices, and Guides
...
- **[Claude Skills Reference](guides/claude-code/claude-skills-reference.md)** - Complete guide to Claude's built-in capabilities
- **[Thinking Levels Guide](guides/claude-code/thinking-levels-guide.md)** - Master extended reasoning: think → ultrathink
- **[Context Optimization](guides/claude-code/context-optimization.md)** - CLAUDE.md mastery for efficient development
- **[Subagent Best Practices](guides/claude-code/subagent-best-practices.md)** - From casual tasks to orchestrating AI teams
...
- Browse [Example Workflows](examples/claude-code/workflows/) for proven patterns
- Check [Community Submissions](community/user-submissions/) for real-world setups
...
1. [Claude Skills Reference](guides/claude-code/claude-skills-reference.md) - What can Claude do?
2. [Thinking Levels](guides/claude-code/thinking-levels-guide.md) - When to use think, think hard, ultrathink
3. [Context Optimization](guides/claude-code/context-optimization.md) - Set up your first CLAUDE.md

### 🔌 Need to Connect External Tools?
**Goal:** Integrate databases, APIs, and services
1. [MCP Servers Guide](guides/claude-code/mcp-servers-guide.md) - Complete MCP reference
2. [MCP Config Template](templates/claude-code/mcp-config-template.json) - Quick setup
3. Start with safe servers: filesystem, git, github

### 🤖 Want to Build AI Teams?
**Goal:** Create specialized subagents
1. [Subagent Best Practices](guides/claude-code/subagent-best-practices.md) - Core concepts
2. [Example Subagents](examples/claude-code/custom-agents/) - Working examples
3. [Subagent Template](templates/claude-code/subagent-template.md) - Create your own

### ⚡ Optimizing Your Workflow?
**Goal:** Maximize productivity
1. [Proven Workflows](examples/claude-code/workflows/) - TDD, debugging, refactoring
2. [Custom Commands](examples/claude-code/custom-commands/) - Automate repeated tasks
3. [Community Submissions](community/user-submissions/) - Learn from others

### 🏢 Setting Up for a Team?
**Goal:** Team-wide configuration
1. [Context Optimization](guides/claude-code/context-optimization.md) - Team CLAUDE.md structure
2. [MCP Servers Guide](guides/claude-code/mcp-servers-guide.md) - Shared tool setup
3. [Example Workflows](examples/claude-code/workflows/) - Standardized patterns
